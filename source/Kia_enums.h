...
enum KIA_GUI_COMMAND
{
    ...
    CONNECT_TO_CORE = 3,
    CONNECT_TO_DB = 4,
    SEND_DATA_TO_STATE_WINDOW = 5,
    SEND_DATA_TO_SETTINGS_WINDOW = 6,
    SET_INFO_TO_WINDOW_INFO = 7,
    SET_WINDOW_INFO_MPI = 8,
    SET_WINDOW_INFO_DEVICE_PROTOCOL = 9,
    SET_STATUS_1S_MARK = 10,
    SET_INFO_TO_ERROR_WINDOW = 11,
    SET_INFO_TO_AI_WINDOW = 12,
    SEND_COMMAND = 13,
    SEND_STATUS_INFO = 14,
    LOAD_PROFILE = 15
};
