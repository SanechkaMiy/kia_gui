...
{
    auto curr_pos = QPoint((int)(m_curr_pos.x() / constants::max_grid_size) * constants::max_grid_size + m_shift,
                           (int)(m_curr_pos.y() / constants::max_grid_size) * constants::max_grid_size + m_shift);
    move(curr_pos);
}
